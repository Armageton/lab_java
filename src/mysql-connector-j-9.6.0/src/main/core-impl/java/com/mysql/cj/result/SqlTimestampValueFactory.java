...
/**
 * A {@link ValueFactory} to create {@link Timestamp} instances.
 *
 * {@link Timestamp} instances are created from fields returned from the database without a time zone. In order to create a <i>point-in-time</i>, a
